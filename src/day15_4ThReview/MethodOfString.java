...
// == .substring() :string - create new string with index given
    ...
    // find the character/string (1st param), t
    // hen replace them with give character/string(2nd param)
    ...
    // no matter what you do with the string. it will be immutable
    // school = school.replace("c",""); <== this will modify the string 
    // then assign value back to the same string
